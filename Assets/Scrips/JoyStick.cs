...
namespace CnControls
{
    ...
    public class JoyStick : MonoBehaviour, IDragHandler, IPointerUpHandler, IPointerDownHandler
    {
        ...
        public virtual void OnDrag(PointerEventData eventData)
        {
            ...
            if (verticalValue < 0)
            {
                playerController.PositionUpButtonOff();
                playerController.PositionDownButtonRepeat();
            }
            if(verticalValue > 0)
            {
                playerController.PositionDownButtonOff();
                playerController.PositionUpButtonRepeat();
            }
        }
